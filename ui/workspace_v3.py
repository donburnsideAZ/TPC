...
class WorkspaceWidget(QWidget):
    ...
    def do_backup(self):
        ...
        from core import backup_to_github, has_github_credentials
        ...
        self.backup_status.setText("Uploading...")
        ...
        result = backup_to_github(
            ...
            remote_url=self.project.github_repo,
            progress_callback=lambda msg: self.backup_status.setText(msg)
        )
